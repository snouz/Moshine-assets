...
--- items
  {
    ...
    pictures =
    {
      ...
      { size = 64, filename = "__Moshine-assets__/graphics/icons/sand-4.png", scale = 0.5 },
      { size = 64, filename = "__Moshine-assets__/graphics/icons/sand-5.png", scale = 0.5 },
      { size = 64, filename = "__Moshine-assets__/graphics/icons/sand-6.png", scale = 0.5 },
      { size = 64, filename = "__Moshine-assets__/graphics/icons/sand-7.png", scale = 0.5 },
      { size = 64, filename = "__Moshine-assets__/graphics/icons/sand-8.png", scale = 0.5 },
      { size = 64, filename = "__Moshine-assets__/graphics/icons/sand-9.png", scale = 0.5 },
    },
    stack_size = 100,
